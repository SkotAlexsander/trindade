...
:root {
  ...
  /* A tarja atrás de um vídeo que não preenche a caixa. Preto de verdade nos
     dois temas: barra de letterbox cinza-claro no tema claro é a coisa mais
     parecida com defeito que existe num player. */
  --media-fundo: #000000;
  ...
  /* A mesma coluna, projetando para o outro lado: a de canais empurra a sombra
     para a direita, a de contexto para a esquerda, e as duas caem sobre a
     conversa, que é o plano mais fundo. */
  --e-coluna-invertida: -6px 0 24px -12px rgba(0, 0, 0, 0.8);
...
[data-theme='light'] {
  ...
  --e-coluna-invertida: -6px 0 24px -12px rgba(10, 24, 38, 0.16);
  ...
  /* No claro o rebaixado é papel um tom mais frio que a superfície, não um
     ...
     O valor foi **medido**, não escolhido: em `#dfe7ee` o texto terciário dava
     4,44:1 e reprovava em AA por seis centésimos. Aqui dá 4,57:1, e continua
     mais escuro que o painel — que é o que faz o campo parecer escavado.
     `packages/web/test/contraste.test.ts` mede a paleta inteira. */
  --bg-inset: #e3eaf0;
  --bg-float: #ffffff;
